...
Revision ID: 66717cf9285a
Revises: 
Create Date: 2026-03-31 21:27:22.163806
...
def upgrade() -> None:
    ...
    sa.Column('calendar', sa.Date(), nullable=False),
    ...
    op.create_table('log_media_item',
    sa.Column('log_media_item_id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('log_id', sa.Integer(), nullable=False),
    sa.Column('media_id', sa.Integer(), nullable=False),
    sa.Column('date_consumed', sa.Date(), nullable=False),
    sa.Column('time_consumed', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['log_id'], ['consumption_log.log_id'], ),
    sa.ForeignKeyConstraint(['media_id'], ['media_item.media_id'], ),
    sa.PrimaryKeyConstraint('log_media_item_id')
    )
